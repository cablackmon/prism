      ...
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        ...
        <div className="space-y-3 py-2">
          <p className="text-sm text-muted-foreground">
            Paste OCR&apos;d text from a recipe photo (iOS Live Text, Google Lens, etc.). KYST will
            split it into title, ingredients, and instructions for you to review before saving.
          </p>
