  ...
  return (
    ...
    >
      ...
      {isSelected && !isDragging && (
        <div
          className={`pointer-events-none absolute left-1/2 top-1 z-10 flex -translate-x-1/2 items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-medium text-white shadow-sm ${
      ...
      {isSelected && !isDragging && (
        <div className="pointer-events-none absolute bottom-1 left-1/2 z-10 -translate-x-1/2 whitespace-nowrap rounded-full bg-black/60 px-2 py-0.5 text-[9px] text-white shadow-sm">
