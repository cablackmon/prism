  ...
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <g className="animate-bounce" style={{ animationDuration: '2s', animationDelay: '0s' }}>
        <path
          d="M80 120 C80 100 60 80 40 100 C20 120 40 150 80 170 C120 150 140 120 120 100 C100 80 80 100 80 120Z"
          fill="#F43F5E"
          opacity="0.8"
        />
      </g>
      <g className="animate-bounce" style={{ animationDuration: '2.3s', animationDelay: '0.3s' }}>
        <path
          d="M320 100 C320 80 300 60 280 80 C260 100 280 130 320 150 C360 130 380 100 360 80 C340 60 320 80 320 100Z"
          fill="#EC4899"
          opacity="0.7"
        />
      </g>
      <g className="animate-bounce" style={{ animationDuration: '1.8s', animationDelay: '0.6s' }}>
        <path
          d="M200 80 C200 55 175 35 150 60 C125 85 150 120 200 150 C250 120 275 85 250 60 C225 35 200 55 200 80Z"
          fill="#E11D48"
        />
      </g>
      {/* Small hearts */}
      <path
        d="M140 200 C140 192 133 186 126 192 C119 198 126 208 140 216 C154 208 161 198 154 192 C147 186 140 192 140 200Z"
        fill="#FB7185"
        className="animate-ping"
        style={{ animationDuration: '2s' }}
      />
      <path
        d="M270 190 C270 182 263 176 256 182 C249 188 256 198 270 206 C284 198 291 188 284 182 C277 176 270 182 270 190Z"
        fill="#FDA4AF"
        className="animate-ping"
...
function stpatricksScene() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <path
        d="M0 280 Q100 50 200 100 Q300 50 400 280"
        fill="none"
        stroke="#EF4444"
        strokeWidth="8"
        opacity="0.3"
      />
      <path
        d="M10 280 Q110 60 200 110 Q290 60 390 280"
        fill="none"
        stroke="#F97316"
        strokeWidth="8"
        opacity="0.3"
      />
      <path
        d="M20 280 Q120 70 200 120 Q280 70 380 280"
        fill="none"
        stroke="#EAB308"
        strokeWidth="8"
        opacity="0.3"
      />
      <path
        d="M30 280 Q130 80 200 130 Q270 80 370 280"
        fill="none"
        stroke="#22C55E"
        strokeWidth="8"
        opacity="0.3"
...
function easterScene() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      />
      <circle cx="145" cy="240" r="3" fill="#93C5FD" />
      <circle cx="155" cy="248" r="3" fill="#93C5FD" />
      <circle cx="148" cy="256" r="3" fill="#93C5FD" />
      <ellipse
        cx="320"
        cy="246"
        rx="17"
      ...
      <g className="animate-wiggle" style={{ transformOrigin: '220px 200px' }}>
        ...
        <ellipse cx="200" cy="115" rx="12" ry="40" fill="white" />
        <ellipse cx="200" cy="115" rx="7" ry="32" fill="#FBCFE8" />
        <ellipse cx="240" cy="120" rx="12" ry="38" fill="white" />
        <ellipse cx="240" cy="120" rx="7" ry="30" fill="#FBCFE8" />
        <circle cx="210" cy="160" r="4" fill="#1a1a1a" />
        <circle cx="230" cy="160" r="4" fill="#1a1a1a" />
        <circle cx="211" cy="158" r="1.5" fill="white" />
        <circle cx="231" cy="158" r="1.5" fill="white" />
      ...
      <text x="100" y="200" style={{ fontSize: '20px' }} className="animate-ping">
        &#10024;
      </text>
      <text x="300" y="180" style={{ fontSize: '16px' }} className="animate-ping">
        &#10024;
      </text>
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <g className="animate-wiggle" style={{ transformOrigin: '120px 200px' }}>
        ...
        <circle cx="120" cy="190" r="18" fill="#F472B6" />
        <circle cx="120" cy="190" r="8" fill="#FBBF24" />
        <circle cx="103" cy="190" r="10" fill="#EC4899" />
        <circle cx="137" cy="190" r="10" fill="#EC4899" />
        <circle cx="120" cy="175" r="10" fill="#EC4899" />
        <circle cx="120" cy="205" r="10" fill="#EC4899" />
      </g>
      <g
        className="animate-wiggle"
        style={{ transformOrigin: '200px 180px', animationDelay: '0.3s' }}
      >
        <line x1="200" y1="180" x2="200" y2="270" stroke="#22C55E" strokeWidth="4" />
        <circle cx="200" cy="170" r="20" fill="#A78BFA" />
        <circle cx="200" cy="170" r="9" fill="#FCD34D" />
        <circle cx="181" cy="170" r="11" fill="#8B5CF6" />
        <circle cx="219" cy="170" r="11" fill="#8B5CF6" />
        <circle cx="200" cy="153" r="11" fill="#8B5CF6" />
        <circle cx="200" cy="187" r="11" fill="#8B5CF6" />
      </g>
      <g
        className="animate-wiggle"
        style={{ transformOrigin: '280px 210px', animationDelay: '0.6s' }}
      >
        <line x1="280" y1="210" x2="280" y2="270" stroke="#22C55E" strokeWidth="4" />
        <circle cx="280" cy="200" r="16" fill="#60A5FA" />
        <circle cx="280" cy="200" r="7" fill="#FBBF24" />
        <circle cx="265" cy="200" r="9" fill="#3B82F6" />
        <circle cx="295" cy="200" r="9" fill="#3B82F6" />
        <circle cx="280" cy="187" r="9" fill="#3B82F6" />
        <circle cx="280" cy="213" r="9" fill="#3B82F6" />
      </g>
      {/* Butterflies */}
  ...
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <g className="animate-wiggle" style={{ transformOrigin: '130px 150px' }}>
        ...
        <rect x="134" y="80" width="60" height="13" fill="#EF4444" />
        <rect x="134" y="93" width="60" height="3" fill="white" />
        <rect x="134" y="96" width="60" height="10" fill="#EF4444" />
        <rect x="134" y="106" width="60" height="3" fill="white" />
        <rect x="134" y="109" width="60" height="11" fill="#EF4444" />
        <rect x="134" y="80" width="22" height="22" fill="#3B82F6" />
        <text x="145" y="96" fill="white" style={{ fontSize: '10px' }}>
          &#9733;
        </text>
      </g>
      <g
        className="animate-wiggle"
        style={{ transformOrigin: '270px 150px', animationDelay: '0.5s' }}
      >
        <line x1="270" y1="80" x2="270" y2="260" stroke="#78716C" strokeWidth="4" />
        <rect x="274" y="80" width="60" height="40" fill="#EF4444" />
        <rect x="274" y="80" width="60" height="13" fill="#EF4444" />
        <rect x="274" y="93" width="60" height="3" fill="white" />
        <rect x="274" y="96" width="60" height="10" fill="#EF4444" />
        <rect x="274" y="106" width="60" height="3" fill="white" />
        <rect x="274" y="109" width="60" height="11" fill="#EF4444" />
        <rect x="274" y="80" width="22" height="22" fill="#3B82F6" />
        <text x="285" y="96" fill="white" style={{ fontSize: '10px' }}>
          &#9733;
        </text>
      </g>
      {/* Stars */}
      ...
      <text x="100" y="160" fill="#EF4444" style={{ fontSize: '20px' }} className="animate-pulse">
        &#9733;
      </text>
      <text x="300" y="170" fill="#EF4444" style={{ fontSize: '18px' }} className="animate-pulse">
        &#9733;
      </text>
    </svg>
  );
...
function july4thScene() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      <text x="50" y="60" style={{ fontSize: '24px' }} fill="#3B82F6" className="animate-pulse">
        &#9733;
      </text>
      <text x="350" y="80" style={{ fontSize: '20px' }} fill="#EF4444" className="animate-pulse">
        &#9733;
      </text>
      <text x="180" y="40" style={{ fontSize: '18px' }} fill="#3B82F6" className="animate-pulse">
        &#9733;
      </text>
      <text x="300" y="50" style={{ fontSize: '22px' }} fill="#EF4444" className="animate-pulse">
        &#9733;
      </text>
      <g className="animate-wiggle" style={{ transformOrigin: '200px 160px' }}>
        ...
        <circle cx="210" cy="127" r="1.5" fill="white" />
  ...
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <g className="animate-float" style={{ animationDuration: '3s', animationDelay: '0.5s' }}>
        <path
          d="M300 100 Q290 90 280 100 Q290 95 300 100 Q310 95 320 100 Q310 90 300 100Z"
          fill="#1a1a1a"
        />
      </g>
      {/* Stars */}
...
function thanksgivingScene() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <g className="animate-wiggle" style={{ transformOrigin: '200px 200px' }}>
        <path
          d="M120 240 Q100 200 130 170 Q160 140 220 150 L280 180 Q240 200 200 220 Q160 240 120 240Z"
          fill="#D2691E"
        />
        <path
          d="M130 235 Q115 200 140 175 Q165 150 215 158"
          fill="none"
          stroke="#8B4513"
          strokeWidth="3"
          opacity="0.5"
...
function christmasScene() {
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      <text x="40" y="50" style={{ fontSize: '16px' }} className="animate-bounce" fill="#93C5FD">
        &#10052;
      </text>
      <text x="340" y="70" style={{ fontSize: '20px' }} className="animate-bounce" fill="#93C5FD">
        &#10052;
      </text>
      <text x="180" y="30" style={{ fontSize: '14px' }} className="animate-bounce" fill="#BFDBFE">
        &#10052;
      </text>
      <text x="280" y="45" style={{ fontSize: '18px' }} className="animate-bounce" fill="#93C5FD">
        &#10052;
      </text>
      <g className="animate-wiggle" style={{ transformOrigin: '200px 180px' }}>
        ...
        <path
          d="M140 280 Q135 200 165 155 Q180 135 200 130"
          fill="none"
          stroke="#B91C1C"
          strokeWidth="3"
          opacity="0.5"
        ...
        <rect
          ...
          style={{ animationDelay: '0s', animationDuration: '2s' }}
        />
        <line x1="182" y1="105" x2="182" y2="130" stroke="#FFD700" strokeWidth="2" />
        <line x1="170" y1="117" x2="195" y2="117" stroke="#FFD700" strokeWidth="2" />
        <rect
          x="200"
          y="100"
          width="22"
          ...
          style={{ animationDelay: '0.3s', animationDuration: '2s' }}
        />
        <line x1="211" y1="100" x2="211" y2="122" stroke="#FCD34D" strokeWidth="2" />
        <line x1="200" y1="111" x2="222" y2="111" stroke="#FCD34D" strokeWidth="2" />
        <rect
          x="155"
          y="115"
          width="18"
          ...
          style={{ animationDelay: '0.6s', animationDuration: '2s' }}
        />
        <line x1="164" y1="115" x2="164" y2="133" stroke="#FDE68A" strokeWidth="1.5" />
        <line x1="155" y1="124" x2="173" y2="124" stroke="#FDE68A" strokeWidth="1.5" />
      </g>
      <circle
        cx="150"
        cy="90"
  ...
  return (
    <svg viewBox="0 0 400 300" className="h-full w-full">
      ...
      <g className="animate-wiggle" style={{ transformOrigin: '200px 170px' }}>
        ...
        <path
          d="M155 120 Q120 120 120 150 Q120 175 155 175"
          fill="none"
          stroke="#FFD700"
          strokeWidth="8"
        />
        <path
          d="M245 120 Q280 120 280 150 Q280 175 245 175"
          fill="none"
          stroke="#FFD700"
          strokeWidth="8"
        />
        ...
        <text x="200" y="170" textAnchor="middle" fill="#8B6914" style={{ fontSize: '36px' }}>
          &#9733;
        </text>
      </g>
      <circle
...
const HOLIDAY_CONFIG: Record<string, { message: (g: string) => string; scene: () => JSX.Element }> =
  {
    ...
    thanksgiving: {
      message: (g) => `So much to be thankful for! ${g} earned!`,
      scene: thanksgivingScene,
    },
...
export function GoalCelebration({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex cursor-pointer items-center justify-center bg-black/40 backdrop-blur-sm duration-300 animate-in fade-in"
      onClick={handleDismiss}
    >
      <div className="flex flex-col items-center gap-4 duration-500 animate-in zoom-in-75">
        <div className="h-52 w-72 sm:h-72 sm:w-96">{scene}</div>
        <div className="rounded-xl border border-border bg-card/95 px-6 py-3 shadow-lg backdrop-blur-sm">
