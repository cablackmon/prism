...
async function seed() {
  ...
  await db.insert(schema.tasks).values([
    ...
    // Today
    {
      title: 'Practice piano (30 min)',
      listId: listSchool.id,
    ...
    {
      title: 'Submit field-trip permission',
      listId: listSchool.id,
    ...
    // Tomorrow
    {
      ...
      priority: 'high',
      category: 'Home',
      description: 'Upstairs faucet is dripping',
      createdBy: jordan.id,
    },
    {
    ...
    },
    {
      ...
      priority: 'high',
      category: 'School',
      description: 'Research the solar system',
      createdBy: emma.id,
    },
    // Next week
    {
    ...
    // No date / inbox
    {
      title: 'Research family vacation ideas',
      listId: listInbox.id,
      assignedTo: jordan.id,
      priority: 'low',
      category: 'Planning',
  ...
  const calSourcesResult = await db
    ...
    .values([
      ...
      },
      {
        userId: alex.id,
        provider: 'local',
        sourceCalendarId: 'alex-local',
        dashboardCalendarName: "Alex's",
        displayName: "Alex's",
        color: '#3B82F6',
        isFamily: false,
        showInEventModal: true,
      ...
      },
      {
        userId: jordan.id,
        provider: 'local',
        sourceCalendarId: 'jordan-local',
        dashboardCalendarName: "Jordan's",
      ...
      },
      {
        userId: emma.id,
        provider: 'local',
        sourceCalendarId: 'emma-local',
        dashboardCalendarName: "Emma's",
        displayName: "Emma's",
        color: '#10B981',
        isFamily: false,
        showInEventModal: true,
      ...
      },
      {
        userId: sophie.id,
        provider: 'local',
        sourceCalendarId: 'sophie-local',
        dashboardCalendarName: "Sophie's",
        displayName: "Sophie's",
        color: '#F59E0B',
        isFamily: false,
        showInEventModal: true,
        enabled: true,
  ...
  await db.insert(schema.events).values([
    // Today
    {
      ...
      startTime: atTime(daysFromNow(0), 16, 0),
      endTime: atTime(daysFromNow(0), 17, 30),
      color: '#10B981',
      createdBy: jordan.id,
    },
    {
      ...
      startTime: atTime(daysFromNow(0), 19, 0),
      endTime: atTime(daysFromNow(0), 21, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
    // Tomorrow
    {
      ...
      startTime: atTime(daysFromNow(1), 9, 0),
      endTime: atTime(daysFromNow(1), 10, 0),
      color: '#3B82F6',
      createdBy: alex.id,
    },
    {
      ...
      startTime: atTime(daysFromNow(1), 18, 0),
      endTime: atTime(daysFromNow(1), 19, 30),
      color: '#F59E0B',
      createdBy: jordan.id,
    },
    // This week
    {
      calendarSourceId: calAlex.id,
      title: 'Team Offsite',
      location: 'Downtown',
      startTime: atTime(daysFromNow(2), 10, 0),
      endTime: atTime(daysFromNow(2), 16, 0),
      color: '#3B82F6',
      createdBy: alex.id,
    },
    {
      ...
      allDay: true,
      startTime: atTime(daysFromNow(3), 0, 0),
      endTime: atTime(daysFromNow(5), 0, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
    {
      ...
      startTime: atTime(daysFromNow(5), 13, 0),
      endTime: atTime(daysFromNow(5), 15, 0),
      color: '#10B981',
      createdBy: jordan.id,
    },
    // Next week
    {
      calendarSourceId: calJordan.id,
      title: "Jordan's Book Club",
      location: 'Coffee shop',
      startTime: atTime(daysFromNow(8), 19, 0),
      endTime: atTime(daysFromNow(8), 21, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
    {
      ...
      allDay: true,
      startTime: atTime(daysFromNow(14), 0, 0),
      endTime: atTime(daysFromNow(21), 0, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
    // Past (for historic views)
    {
      ...
      location: 'Maple Elementary',
      startTime: atTime(daysAgo(7), 16, 0),
      endTime: atTime(daysAgo(7), 17, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
  ]);
  ...
  await db.insert(schema.events).values([
    ...
    // Daily school drop-off (weekdays 8-8:30am, until end of school year)
    {
      ...
      recurring: true,
      recurrenceRule:
        'FREQ=WEEKLY;BYDAY=MO,TU,WE,TH,FR;UNTIL=' +
        ymd(daysFromNow(45)).replace(/-/g, '') +
        'T000000Z',
      color: '#3B82F6',
      createdBy: alex.id,
    },
  ...
  await db.insert(schema.events).values([
    // ── Past two weeks ──────────────────────────────────────────────────────
    {
      ...
      title: 'Soccer Game',
      location: 'Community Park',
      startTime: atTime(daysAgo(11), 10, 0),
      endTime: atTime(daysAgo(11), 11, 30),
      color: '#10B981',
      createdBy: jordan.id,
    },
    {
      ...
      title: 'Dentist',
      location: "Dr. Smith's Office",
      startTime: atTime(daysAgo(6), 8, 0),
      endTime: atTime(daysAgo(6), 8, 45),
      color: '#3B82F6',
      createdBy: alex.id,
    },
    {
      calendarSourceId: calFamily.id,
      title: "Dinner at Grandma Helen's",
      startTime: atTime(daysAgo(3), 17, 30),
      endTime: atTime(daysAgo(3), 20, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
    // ── This week and next ──────────────────────────────────────────────────
    {
      calendarSourceId: calSophie.id,
      title: 'Piano Lesson',
      startTime: atTime(daysFromNow(2), 16, 0),
      endTime: atTime(daysFromNow(2), 16, 45),
      color: '#F59E0B',
      createdBy: jordan.id,
    },
    {
      ...
      title: 'Art Class',
      location: 'Community Center',
      startTime: atTime(daysFromNow(3), 16, 0),
      endTime: atTime(daysFromNow(3), 17, 0),
      color: '#10B981',
      createdBy: jordan.id,
    },
    {
      calendarSourceId: calFamily.id,
      title: 'No School: Teacher Workday',
      allDay: true,
      startTime: atTime(daysFromNow(4), 0, 0),
      endTime: atTime(daysFromNow(5), 0, 0),
      color: '#EC4899',
      createdBy: jordan.id,
    },
    {
      ...
      startTime: atTime(daysFromNow(6), 12, 0),
      endTime: atTime(daysFromNow(6), 15, 0),
      color: '#EC4899',
      createdBy: alex.id,
    },
    {
      calendarSourceId: calSophie.id,
      title: 'Birthday Party for Lucas',
      startTime: atTime(daysFromNow(7), 14, 0),
      endTime: atTime(daysFromNow(7), 16, 0),
      color: '#F59E0B',
      createdBy: jordan.id,
    },
    // ── Two to three weeks out ──────────────────────────────────────────────
    {
      ...
      location: 'Chicago',
      allDay: true,
      startTime: atTime(daysFromNow(9), 0, 0),
      endTime: atTime(daysFromNow(12), 0, 0),
      color: '#3B82F6',
      createdBy: alex.id,
    },
    {
      ...
      allDay: true,
      startTime: atTime(daysFromNow(11), 0, 0),
      endTime: atTime(daysFromNow(12), 0, 0),
      color: '#10B981',
      createdBy: jordan.id,
    },
    {
      calendarSourceId: calFamily.id,
      title: 'Family Movie Night',
      startTime: atTime(daysFromNow(13), 19, 0),
      endTime: atTime(daysFromNow(13), 21, 0),
      color: '#EC4899',
      createdBy: alex.id,
    },
    // ── A few weeks out ─────────────────────────────────────────────────────
    {
      ...
      location: 'Coastline',
      allDay: true,
      startTime: atTime(daysFromNow(16), 0, 0),
      endTime: atTime(daysFromNow(19), 0, 0),
      color: '#EC4899',
      createdBy: alex.id,
    },
    {
      ...
      title: 'Piano Recital',
      location: 'School Auditorium',
      startTime: atTime(daysFromNow(26), 18, 0),
      endTime: atTime(daysFromNow(26), 19, 30),
      color: '#10B981',
      createdBy: jordan.id,
    },
    {
      ...
      location: 'State Park',
      allDay: true,
      startTime: atTime(daysFromNow(34), 0, 0),
      endTime: atTime(daysFromNow(36), 0, 0),
      color: '#EC4899',
      createdBy: alex.id,
    },
  ]);
  ...
  await db.insert(schema.calendarNotes).values([
    {
      date: ymd(daysFromNow(0)),
      content: 'Pickup line will be a mess after the science fair — leave early',
      createdBy: jordan.id,
    },
    {
      date: ymd(daysFromNow(3)),
      content: "<b>Grandma's allergies:</b> peanuts, shellfish. Plan meals accordingly.",
      createdBy: jordan.id,
    },
    {
      date: ymd(daysFromNow(14)),
      content: 'Spring break itinerary draft — confirm hotel by Monday',
      createdBy: alex.id,
    },
  ]);
  ...
  const choresResult = await db
    ...
    .values([
      ...
      },
      {
        ...
        pointValue: 2,
        requiresApproval: false,
        nextDue: ymd(daysFromNow(2)),
        createdBy: jordan.id,
        startDay: String((NOW.getDay() + 2) % 7),
      },
      {
        title: 'Feed the pets',
      ...
      {
        title: 'Take out trash',
        description: 'Curb by 7am Friday',
        category: 'trash',
        assignedTo: emma.id,
        frequency: 'weekly',
        pointValue: 5,
        requiresApproval: false,
        nextDue: ymd(daysFromNow((5 - NOW.getDay() + 7) % 7)),
        createdBy: alex.id,
        startDay: '5',
      },
      {
        title: 'Sweep front porch',
        description: 'Sweep and water the plants',
        category: 'yard',
        assignedTo: sophie.id,
        frequency: 'weekly',
        pointValue: 5,
        requiresApproval: false,
        nextDue: ymd(daysFromNow(3)),
        createdBy: alex.id,
        startDay: '6',
      },
      {
        title: 'Load + run washer',
        description: 'Family colors load',
        category: 'laundry',
        assignedTo: jordan.id,
        frequency: 'weekly',
        pointValue: 0,
        requiresApproval: false,
        nextDue: ymd(daysFromNow(1)),
        createdBy: jordan.id,
      },
      {
        title: 'Clean bathroom',
        description: 'Sink, toilet, mirror',
        category: 'cleaning',
        assignedTo: emma.id,
        frequency: 'weekly',
        pointValue: 15,
        requiresApproval: true,
        nextDue: ymd(daysFromNow(4)),
        createdBy: jordan.id,
      },
    ])
    .returning();
  ...
  const shoppingItemRows: (typeof schema.shoppingItems.$inferInsert)[] = [
    ...
    },
    {
      ...
      category: 'household',
      addedBy: alex.id,
      notes: 'For the leaky bathroom faucet',
    },
    ...
    .values([
      {
        ...
        description:
          'Family-favorite weeknight dinner — meatballs, garlic fries, tzatziki, all on one sheet pan.',
        sourceType: 'manual',
        ingredients: [
          { heading: 'Fries:' },
  ...
  const SEED_DAY_NUM: Record<string, number> = {
    sunday: 0,
    monday: 1,
    tuesday: 2,
    wednesday: 3,
  ...
  await db.insert(schema.meals).values(
    [
      ...
      ...m,
      date: seedMealDate(m.weekOf, m.dayOfWeek),
    })) as (typeof schema.meals.$inferInsert)[]
  );
  ...
  await db.insert(schema.maintenanceReminders).values([
    ...
    },
    {
      ...
      category: 'home',
      schedule: 'monthly',
      nextDue: ymd(daysFromNow(15)),
      createdBy: jordan.id,
    },
    {
      title: 'Clean gutters',
      category: 'home',
      description: 'Front and back gutters before winter',
      schedule: 'custom',
      customIntervalDays: 180,
      nextDue: ymd(daysFromNow(60)),
      assignedTo: alex.id,
      createdBy: alex.id,
    },
    {
  ...
  await db.insert(schema.goals).values([
    ...
    {
      name: 'New LEGO Set',
      description: 'Earn a new LEGO set',
      pointCost: 300,
      emoji: '🧱',
      priority: 4,
      recurring: false,
  ...
  await db.insert(schema.babysitterInfo).values([
    ...
    },
    {
      ...
      content: {
        name: 'Grandma Helen',
        relationship: 'Grandmother, 5 min away',
        phone: '(555) 234-2020',
        isPrimary: 'false',
      },
    },
    ...
    // House info (WiFi password + door code marked sensitive = PIN to reveal)
    {
      section: 'house_info',
      sortOrder: 0,
      content: { label: 'Address', value: '42 Maple Street, Springfield, IL' },
    },
    {
      section: 'house_info',
      sortOrder: 1,
      content: { label: 'WiFi Network', value: 'ParkerFamily' },
    },
    {
      section: 'house_info',
      sortOrder: 2,
      content: { label: 'WiFi Password', value: 'sunflower-2231' },
      isSensitive: true,
    },
    {
      section: 'house_info',
      sortOrder: 3,
      content: { label: 'Front Door Code', value: '4297' },
      isSensitive: true,
    },
    {
      section: 'house_info',
      sortOrder: 4,
      content: { label: 'Trash Day', value: 'Friday morning, bins by the curb' },
    },
    // Children
    {
      section: 'child_info',
      ...
      content: {
        ...
        medications: 'None',
        bedtime: '8:30 PM',
        notes: 'Reads before lights out. Nightlight stays on.',
      },
    },
    {
      section: 'child_info',
      ...
      content: {
        name: 'Sophie',
        age: '8',
        allergies: 'Peanuts (EpiPen in kitchen drawer)',
        medications: 'None',
        bedtime: '7:30 PM',
        notes: 'Needs her stuffed otter to sleep. Story after teeth brushing.',
      },
    },
    // House rules
    {
      section: 'house_rule',
      sortOrder: 0,
      content: { rule: 'Screens off one hour before bedtime.', importance: 'high' },
    },
    {
      section: 'house_rule',
      sortOrder: 1,
      content: {
        rule: 'Snacks are okay from the pantry, no candy after dinner.',
        importance: 'medium',
      },
    },
    {
      section: 'house_rule',
      sortOrder: 2,
      content: { rule: 'Keep the back door locked and the pool gate closed.', importance: 'high' },
    },
  ]);
  ...
  await db.insert(schema.wishItems).values([
    ...
    {
      memberId: emma.id,
      name: 'Art set with watercolors',
      notes: 'The 48-color kind',
      addedBy: emma.id,
    },
    {
      memberId: emma.id,
      name: 'Mystery book series',
      url: 'https://example.com/books',
      addedBy: emma.id,
    },
    {
      memberId: emma.id,
      name: 'Roller skates (size 4)',
      addedBy: emma.id,
      sortOrder: 2,
      claimed: true,
      claimedBy: alex.id,
    ...
    {
      memberId: sophie.id,
      name: 'Stuffed animal (otter)',
      notes: 'The one from the aquarium',
      addedBy: sophie.id,
    },
    {
      memberId: sophie.id,
    ...
    { memberId: jordan.id, name: 'Cookbook — sheet pan dinners', addedBy: jordan.id },
    {
      ...
      notes: 'Size 8 in the trail version',
      addedBy: jordan.id,
    },
    // Alex's wishes
  ...
  await db.insert(schema.giftIdeas).values([
    // Alex's gift ideas for the rest of the family
    {
      ...
      notes: 'Anniversary idea',
      price: '180',
    },
    {
      createdBy: alex.id,
      forUserId: emma.id,
      name: 'Bike helmet upgrade',
      notes: 'Hers is getting small',
      price: '45',
    },
  ...
  await db.insert(schema.travelPins).values([
    {
      ...
      latitude: '26.4498',
      longitude: '-82.1147',
      placeName: 'Sanibel Island, FL',
      status: 'been_there',
      visitedDate: '2024-03-15',
      year: 2024,
      tags: ['Beach', 'Family Trip'],
      createdBy: alex.id,
    },
    {
      ...
      latitude: '48.7596',
      longitude: '-113.7870',
      placeName: 'Glacier NP, MT',
      status: 'want_to_go',
      isBucketList: true,
      tags: ['National Park', 'Hike'],
      createdBy: jordan.id,
    },
    {
    ...
    },
    {
      ...
      latitude: '44.4280',
      longitude: '-110.5885',
      placeName: 'Yellowstone NP, WY',
      status: 'been_there',
      visitedDate: '2023-07-10',
      year: 2023,
      tags: ['National Park'],
      nationalParks: ['Yellowstone National Park'],
      createdBy: alex.id,
    },
    {
      name: 'Grand Canyon',
      latitude: '36.1069',
      longitude: '-112.1129',
      placeName: 'Grand Canyon NP, AZ',
      status: 'been_there',
      visitedDate: '2022-10-20',
      year: 2022,
      tags: ['National Park'],
      nationalParks: ['Grand Canyon National Park'],
      createdBy: jordan.id,
    },
  ]);
  ...
  const tripResult = await db
    ...
    .values([
      {
        name: 'Summer Pacific NW Road Trip',
        tripStyle: 'route',
        status: 'want_to_go',
        year: NOW.getFullYear(),
        color: '#10B981',
        emoji: '🌲',
        tags: ['Road Trip', 'National Park'],
        createdBy: alex.id,
        memberIds: [alex.id, jordan.id, emma.id, sophie.id],
      },
    ])
    .returning();
  ...
  await db.insert(schema.travelPins).values([
    ...
    },
    {
      ...
      latitude: '47.8021',
      longitude: '-123.6044',
      placeName: 'Olympic National Park, WA',
      tripId: tripPNW.id,
      pinType: 'national_park',
      sortOrder: 1,
      status: 'want_to_go',
      nationalParks: ['Olympic National Park'],
      createdBy: alex.id,
    },
    {
      ...
      latitude: '46.8523',
      longitude: '-121.7603',
      placeName: 'Mount Rainier NP, WA',
      tripId: tripPNW.id,
      pinType: 'national_park',
      sortOrder: 2,
      status: 'want_to_go',
      nationalParks: ['Mount Rainier National Park'],
      createdBy: alex.id,
    },
    {
      name: 'Portland',
    ...
    },
    {
      ...
      latitude: '42.8684',
      longitude: '-122.1685',
      placeName: 'Crater Lake NP, OR',
      tripId: tripPNW.id,
      pinType: 'national_park',
      sortOrder: 4,
      status: 'want_to_go',
      nationalParks: ['Crater Lake National Park'],
      createdBy: alex.id,
    },
  ]);
  ...
  await db.insert(schema.weekendPlaces).values([
    {
      ...
      description: 'Big shaded trails — kids can ride scooters',
      tags: ['outdoor', 'hike', 'nature'],
      status: 'visited',
      isFavorite: true,
      rating: 5,
      visitCount: 8,
      lastVisitedDate: ymd(daysAgo(10)),
      createdBy: alex.id,
    },
    {
      name: "Children's Museum",
      description: 'Indoor backup for rainy days',
      tags: ['museum', 'kids'],
      status: 'visited',
      isFavorite: false,
      rating: 4,
      visitCount: 3,
      lastVisitedDate: ymd(daysAgo(30)),
      createdBy: jordan.id,
    },
    {
      name: 'Lavender Farm',
      description: 'Late-June bloom, picnic spot',
      tags: ['farm', 'outdoor', 'food'],
      status: 'visited',
      isFavorite: true,
      rating: 5,
      visitCount: 2,
      lastVisitedDate: ymd(daysAgo(220)),
      createdBy: jordan.id,
    },
    {
      name: 'Wildlife Sanctuary',
      description: 'Free entry, walking trails, rescued animals',
    ...
    },
    {
      ...
      description: 'Open weekends only May-Oct',
      tags: ['movie', 'family'],
      status: 'backlog',
      isFavorite: true,
      createdBy: alex.id,
    },
    {
      ...
      description: 'Sophie has been asking',
      tags: ['indoor', 'kids'],
      status: 'backlog',
      isFavorite: false,
      createdBy: sophie.id,
    ...
    {
      name: 'Pumpkin Patch (Hillview)',
      description: 'Hayrides + cider donuts in October',
      tags: ['outdoor', 'seasonal', 'farm'],
      status: 'visited',
      isFavorite: true,
      rating: 5,
      visitCount: 4,
      lastVisitedDate: ymd(daysAgo(180)),
      createdBy: jordan.id,
    },
    {
      name: 'Local diner',
      description: 'Best Sunday breakfast in town',
      tags: ['food'],
      status: 'visited',
      isFavorite: true,
      rating: 5,
      visitCount: 12,
      lastVisitedDate: ymd(daysAgo(7)),
      createdBy: alex.id,
    },
  ]);
