...
export const LAYOUT_TEMPLATES: Record<string, LayoutTemplate> = {
  ...
  familyCentral: {
    name: 'Family Central',
    description:
      'Calendar hero with a tall upcoming-events column and an at-a-glance weather + clock strip.',
  ...
  calendarFocus: {
    name: 'Calendar Focus',
    description:
      'A full-height calendar with a slim weather + clock rail — for when the schedule is everything.',
    orientation: 'landscape',
    widgets: [
  ...
  commandCenter: {
    name: 'Command Center',
    description:
      'Everything at a glance — calendar hero plus weather, clock, and your task, chore, and message lists.',
    orientation: 'landscape',
    widgets: [
  ...
  mealPlanner: {
    name: 'Meal Planner',
    description:
      'Kitchen board — meals front and center with a tall shopping list and a weather + clock corner.',
    orientation: 'landscape',
    widgets: [
  ...
  schoolMornings: {
    ...
    description:
      'Out-the-door board — calendar, a bus departure countdown, weather, homework tasks, and the lunch menu.',
    orientation: 'landscape',
    widgets: [
  ...
  ambient: {
    name: 'Ambient',
    description:
      'Photo-forward — your wallpaper takes the screen, with glassy floating clock and weather accents. Pair with a photo wallpaper.',
    orientation: 'landscape',
  ...
  familyCentralPortrait: {
    name: 'Family Central',
    description:
      'Calendar hero with weather + clock bands above and a tall upcoming-events list below.',
  ...
  commandCenterPortrait: {
    name: 'Command Center',
    description:
      'Everything at a glance — weather/clock, a calendar hero, task and chore columns, and messages.',
    orientation: 'portrait',
    widgets: [
  ...
  mealPlannerPortrait: {
    name: 'Meal Planner',
    description:
      'Kitchen board — a weather/clock strip over a meals hero and a tall shopping list.',
    orientation: 'portrait',
    widgets: [
  ...
  schoolMorningsPortrait: {
    name: 'School Mornings',
    description:
      'Out-the-door board — bus countdown up top, weather, a calendar hero, and the lunch menu.',
    orientation: 'portrait',
    widgets: [
  ...
  ambientPortrait: {
    name: 'Ambient',
    description:
      'Photo-forward — your wallpaper takes the screen, with glassy clock and weather accents top and bottom.',
    orientation: 'portrait',
