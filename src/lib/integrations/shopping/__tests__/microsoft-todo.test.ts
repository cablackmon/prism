...
describe('microsoftTodoShoppingProvider', () => {
  ...
  describe('updateItem', () => {
    it('sends PATCH with name, notes, and checked', async () => {
      ...
      const result = await microsoftTodoShoppingProvider.updateItem(TOKENS, 'task-1', 'list-1', {
        name: 'Updated',
        notes: 'New note',
        checked: true,
      });
    ...
    it('sets body to null when notes cleared', async () => {
      ...
      await microsoftTodoShoppingProvider.updateItem(TOKENS, 'task-1', 'list-1', { notes: null });
    ...
    it('maps unchecked to notStarted status', async () => {
      ...
      await microsoftTodoShoppingProvider.updateItem(TOKENS, 'task-1', 'list-1', {
        checked: false,
      });
  ...
  describe('error handling', () => {
    it('throws on non-OK response', async () => {
      ...
      await expect(microsoftTodoShoppingProvider.fetchLists(TOKENS)).rejects.toThrow(
