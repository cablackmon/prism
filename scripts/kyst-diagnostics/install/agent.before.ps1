...
function Restart-FamilyBoard {
    ...
    if($invocation -notin @('nox11625-refresh-baseline','nox11625-refresh-classic','nox11625-refresh-nox-return')){throw 'Refresh requires one of the three reviewed invocation IDs'}
